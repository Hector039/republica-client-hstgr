					...
					{user.is_admin === 1 && (
						<div className="user-info-container">
							...
							<NavLink to={`/daily`} className="get-debtors-button">
								Consultar caja diaria efectivo
							</NavLink>
							<NavLink to={`/dailycvu`} className="get-debtors-button">
								Consultar caja diaria CVU
							</NavLink>

							<NavLink to={`/monthly`} className="get-debtors-button">
								Consultar caja mensual efectivo
							</NavLink>
							<NavLink to={`/monthlycvu`} className="get-debtors-button">
								Consultar caja mensual CVU
							</NavLink>
